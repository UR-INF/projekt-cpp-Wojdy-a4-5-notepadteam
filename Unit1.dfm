object Form1: TForm1
  ...
  object OpenDialog1: TOpenDialog
    Filter = 
      'Pliki tekstowe (TXT)|*.txt|Wszystkie pliki|*.*|Pliki tekstowe (P' +
      'HP)|*.php|Pliki tekstowe (HTML)|*.html'
    Left = 488
    Top = 8
  end
  object SaveDialog1: TSaveDialog
    Filter = 
      'Plik tekstowy (TXT)|*.txt|Dowolny plik|*.*|Plik tekstowy (PHP)|*' +
      '.php|Plik tekstowy (HTML)|*.html'
